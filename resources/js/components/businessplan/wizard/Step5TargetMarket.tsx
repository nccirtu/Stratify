            ...
            <CardContent>
                <FieldSet>
                    ...
                    <FieldGroup>
                        <Field>
                            <FieldLabel>
                                Wie hoch ist der Innovationsgrad deines
                                Geschäfts?
                            </FieldLabel>
                            <RadioGroup
                                value={data.inovation_level || ''}
                                onValueChange={(v) =>
                                    setData({ inovation_level: v })
                                }
                        ...
                        <Field>
                            <FieldLabel>
                                Welche Alleinstellungsmerkmale (USPs) sind
                                vorhanden?
                            </FieldLabel>
                            <MultiSelect
                                values={selectedUsps}
                            ...
                            {errors.usp && (
                                <FieldError>{errors.usp}</FieldError>
                            )}
                        </Field>
                        ...
                        {selectedUsps.includes('price_leadership') && (
                            <Field>
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.priceLeaderships.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
                        ...
                        {selectedUsps.includes('quality_leadership') && (
                            <Field>
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.qualityLeaderships.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
                        ...
                        {selectedUsps.includes('specialist_leadership') && (
                            <Field>
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.specialistLeaderships.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
                        ...
                        {selectedUsps.includes('technology_leadership') && (
                            <Field>
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.technologyLeaderships.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
                        ...
                        {selectedUsps.includes('exclusive_leadership') && (
                            <Field>
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.exclusiveLeaderships.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
                        ...
                        {selectedUsps.includes('community_leadership') && (
                            <Field>
                                <FieldLabel>
                                    Welche Reichweite haben Sie mit Ihrer Marke
                                    und Community?
                                </FieldLabel>
                                <MultiSelect
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.communityLeaderships.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
                        ...
                        <Field>
                            <FieldLabel htmlFor="usp_text">
                                Beschreiben Sie einige Details zu Ihren
                                ausgewählten Alleinstellungsmerkmalen
                            </FieldLabel>
                            <Textarea
                                id="usp_text"
                                value={data.usp_text || ''}
                                onChange={(e) =>
                                    setData({ usp_text: e.target.value })
                                }
                                rows={4}
