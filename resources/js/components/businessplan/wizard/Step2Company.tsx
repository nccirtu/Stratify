        ...
        <Card>
            <CardContent>
                <FieldSet>
                    ...
                    <FieldDescription>
                        Erfassen Sie die grundlegenden Informationen zu Ihrem
                        Unternehmen.
                    </FieldDescription>
                    <FieldGroup>
                        <Field>
                        ...
                        {showIsHeadquarter && (
                            <Field>
                                <FieldLabel>
                                    Ist schon bekannt wo das Unternehmen seinen
                                    Sitz haben wird?
                                </FieldLabel>
                                <ToggleGroup
                                    type="single"
                        ...
                        {showExpectedHeadquarters && (
                            <Field>
                                <FieldLabel htmlFor="expected_headquarters">
                                    Wo wäre voraussichtlich der Sitz des
                                    Unternehmens?
                                </FieldLabel>
                                <Input
