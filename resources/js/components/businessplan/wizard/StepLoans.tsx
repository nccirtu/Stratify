                            ...
                            <div className="border-t px-4 pb-4 pt-3">
                                <FieldGroup>
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <Field>
                                            <FieldLabel>Darlehensbetrag (€)</FieldLabel>
                                            <Input
                                                type="number"
                                                min={0}
                                                ...
                                                aria-invalid={
                                                    !!errors[`loans.${index}.loan_amount`]
                                                }
                                            />
                                            {errors[`loans.${index}.loan_amount`] && (
                                                <FieldError>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Field>
                                            <FieldLabel>Zinssatz (% p.a.)</FieldLabel>
                                            <Input
                                                type="number"
                                                min={0}
                                                step="0.01"
                                                ...
                                                aria-invalid={
                                                    !!errors[`loans.${index}.interest_rate`]
                                                }
                                            />
                                            {errors[`loans.${index}.interest_rate`] && (
                                                <FieldError>
                                        ...
                                        <Field>
                                            <FieldLabel>Monatliche Rate (€)</FieldLabel>
                                            <Input
                                                type="number"
                                                min={0}
                                                ...
                                                aria-invalid={
                                                    !!errors[`loans.${index}.monthly_installment`]
                                                }
                                            />
                                            {errors[`loans.${index}.monthly_installment`] && (
                                                <FieldError>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        ...
                                        <Field>
                                            ...
                                            <Input
                                                ...
                                                aria-invalid={
                                                    !!errors[`loans.${index}.payment_day`]
                                                }
                                            />
                                            {errors[`loans.${index}.payment_day`] && (
                                                <FieldError>
