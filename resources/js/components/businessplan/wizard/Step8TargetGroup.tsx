                    ...
                    <FieldGroup>
                        <Field>
                            ...
                            >
                                ...
                                <MultiSelectContent>
                                    {enumOptions.purchaseDecisions.map(
                                        (opt) => (
                        ...
                        {isB2C && (
                            <>
                                <Field>
                                    <FieldLabel>
                                        Zu welcher Altersgruppe gehört Ihr
                                        Zielkunde?
                                    </FieldLabel>
                                    <RadioGroup
                                ...
                                <Field>
                                    <FieldLabel>
                                        In welcher Lebenssituation ist Ihr
                                        Zielkunde?
                                    </FieldLabel>
                                    <RadioGroup
                                    ...
                                    >
                                        {enumOptions.lifeSituations.map(
                                            (opt) => (
                                                <Tooltip key={opt.value}>
                                                    <TooltipTrigger asChild>
                                                        <div className="flex items-center gap-2">
                                ...
                                <Field>
                                    ...
                                    <MultiSelect
                                        values={
                                            data.information_target_group ?? []
                                        }
                                        onValuesChange={(v) =>
                                            setData({
                                                information_target_group: v,
                                            })
                                        }
                                    >
                                        <MultiSelectTrigger>
                                        ...
                                        <MultiSelectContent>
                                            {enumOptions.informationTargetGroups.map(
                                                (opt) => (
                                                    <TooltipMultiSelectItem
                                                        key={opt.value}
                                                        opt={opt}
                        ...
                        {isB2B && (
                            <Field>
                                ...
                                >
                                    ...
                                    <MultiSelectContent>
                                        {enumOptions.companyTargetGroups.map(
                                            (opt) => (
                                                <TooltipMultiSelectItem
                                                    key={opt.value}
                                                    opt={opt}
