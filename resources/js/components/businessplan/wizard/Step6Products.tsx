        ...
        <Card>
            <CardContent>
                <FieldSet>
                    ...
                    <FieldDescription>
                        Beschreiben Sie Ihr Angebot, den Entwicklungsstand und
                        Ihre Preisstrategie.
                    </FieldDescription>
                    <FieldGroup>
                        <Field>
                        ...
                        <Field>
                            <FieldLabel>
                                Wie ist der aktuelle Entwicklungsstand Ihres
                                Angebots?
                            </FieldLabel>
                            <RadioGroup
                                value={data.development_state || ''}
                                onValueChange={(v) =>
                                    setData({ development_state: v })
                                }
