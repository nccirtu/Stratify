...
export default function StepEmployees({
    ...
    return (
        <FieldSet>
            ...
            <FieldDescription>
                Erfassen Sie Ihre geplanten Mitarbeiter und deren Gehälter.
            </FieldDescription>
                        ...
                        <CollapsibleContent>
                            <div className="border-t px-4 pb-4 pt-3">
                                <FieldGroup>
                                    <div className="grid grid-cols-2 gap-4">
                                        <Field>
                                            ...
                                            <Input
                                                ...
                                                aria-invalid={
                                                    !!errors[`employees.${index}.job_title`]
                                                }
                                            />
                                            {errors[`employees.${index}.job_title`] && (
                                                <FieldError>
                                        ...
                                        <Field>
                                            <FieldLabel>Anzahl Mitarbeiter</FieldLabel>
                                            <Input
                                                type="number"
                                                min={1}
                                                value={item.number_of_employees}
                                                onChange={(e) =>
                                                    updateItem(index, {
                                                ...
                                                aria-invalid={
                                                    !!errors[`employees.${index}.number_of_employees`]
                                                }
                                            />
                                            {errors[`employees.${index}.number_of_employees`] && (
                                                <FieldError>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Field>
                                            <FieldLabel>Bruttogehalt (€/Monat)</FieldLabel>
                                            <Input
                                                type="number"
                                                min={0}
                                                value={item.salary}
                                        ...
                                        <Field>
                                            <FieldLabel>Zahltag (1–31)</FieldLabel>
                                            <Input
                                                type="number"
                                                min={1}
                                                max={31}
                                                ...
                                                aria-invalid={
                                                    !!errors[`employees.${index}.payment_day`]
                                                }
                                            />
                                            {errors[`employees.${index}.payment_day`] && (
                                                <FieldError>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Field>
                                            <FieldLabel>Einstellungsdatum</FieldLabel>
                                            <Input
                                                type="date"
                                                value={item.date_of_hire}
                                                onChange={(e) =>
                                                    updateItem(index, {
                                                        date_of_hire: e.target.value,
                                                    })
                                                }
                                                aria-invalid={
                                                    !!errors[`employees.${index}.date_of_hire`]
                                                }
                                            />
                                            {errors[`employees.${index}.date_of_hire`] && (
                                                <FieldError>
                                        ...
                                        <Field>
                                            <FieldLabel>Wochenstunden</FieldLabel>
                                            <Input
                                                type="number"
                                                min={0}
                                                value={item.working_hours_per_week}
                                                onChange={(e) =>
                                                    updateItem(index, {
                                                        working_hours_per_week: e.target.value,
                                                    })
                                                }
                                            />
                                        </Field>
                                    ...
                                    <Field>
                                        <FieldLabel>Qualifikation</FieldLabel>
                                        <Input
                                    ...
                                    <Field>
                                        <FieldLabel>Aufgabenbereich</FieldLabel>
                                        <Textarea
                                            value={item.area_of_responsibility}
                                            onChange={(e) =>
                                                updateItem(index, {
                                                    area_of_responsibility: e.target.value,
                                                })
                                            }
                                            rows={2}
