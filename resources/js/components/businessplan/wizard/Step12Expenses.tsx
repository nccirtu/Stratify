...
export default function Step12Expenses({
    data,
    setData,
    errors,
    options,
    ...
    const updateItem = (index: number, patch: Partial<TransactionItem>) => {
        ...
        setData({ expense_transactions: updated });
    };
    ...
    const handleCatalogChange = (index: number, catalogItemId: string) => {
        const catalog = options.expenseCatalogItems.find(
    ...
    return (
        <Card>
            <CardContent>
                <FieldSet>
                    <FieldLegend>Ausgaben</FieldLegend>
                    <FieldDescription>
